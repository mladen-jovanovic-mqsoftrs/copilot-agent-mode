    ...
    <Router>
      <div className="container mt-4">
        ...
        <Routes>
          ...
          <Route path="/" element={<div className="card p-4"><h2 className="card-title text-center">Welcome to Octofit Tracker!</h2><p className="card-text text-center">Track your fitness, join teams, and compete on the leaderboard!</p></div>} />
        </Routes>
      </div>
    </Router>
  );
